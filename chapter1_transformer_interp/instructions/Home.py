...
This section (not including the final section on fully reverse-engineering the model circuit) is compulsory, as the ideas and techniques underpinning this section will reoccur in all subsequent parts of this chapter.
    ...
    ChapterContent(
        name="[1.3.1] Linear Probing",
        description=r"""TODO(mcdougallc) - fill in""",
        section_description=None,
    ),
    ChapterContent(
        name="[1.3.2] Function Vectors & Model Steering",
        description=r"""TODO(mcdougallc) - fill in""",
        section_description=None,
    ),
    ChapterContent(
...
""",
    ...
    ChapterContent(
        name="[1.5.4] Toy Models of Superposition & SAEs",
...
You'll also build the sparse autoencoder (SAE) architecture and train it to recover the features learned by these toy models, even replicating some more recent results such as those from [DeepMind's Gated SAE paper](https://deepmind.google/research/publications/88147/). This section can be viewed as a deep dive into the theory that underpins the more practical SAE-based content in 1.3.3 and 1.4.2.""",
        section_description=None,
    ),
    ChapterContent(
...
""",
    ...
    ChapterContent(
        name="[1.6.1] Emergent Misalignment",
        description=r"""TODO(mcdougallc) - fill in (emphasis on OOCR, LORA and some internals-y stuff)""",
        section_description=None,
    ),
    ChapterContent(
        name="[1.6.2] Science of Misalignment",
        description=r"""TODO(mcdougallc) - fill in (emphasis on studying existing models not finetuning explicitly for negative behaviour)""",
        section_description=None,
    ),
    ChapterContent(
        name="[1.6.3] Eliciting Secret Knowledge",
        description=r"""TODO(mcdougallc) - fill in""",
        section_description=None,
    ),
    ChapterContent(
        name="[1.6.4] Interpreting Reasoning Models",
        description=r"""TODO(mcdougallc) - fill in""",
        section_description=None,
    ),
]
...
- From this optional material, we most strongly recommend the following sets:
    - 1.5.1 (easier than most sections, and lets you play around more with transformer architecture in simple cases)
    - 1.4.1 (best intro to circuit-based interp)
...
* [ARENA Slack group invite link](https://join.slack.com/t/arena-uk/shared_invite/zt-39iwnhbj4-pMWUvZkkt2wpvaxkvJ0q2rRQ)
