...
#     ...
# ]
metadata = [{'title': 'Load & Test Model Organisms', 'icon': '1-circle-fill', 'subtitle': '(15%)'}, {'title': 'Quantifying Deceptive Behavior', 'icon': '2-circle-fill', 'subtitle': '(25%)'}, {'title': 'Activation Steering', 'icon': '3-circle-fill', 'subtitle': '(30%)'}, {'title': 'LoRA specialization', 'icon': '4-circle-fill', 'subtitle': '(30%)'}, {'title': 'Bonus', 'icon': 'star', 'subtitle': '(10%)'}]
